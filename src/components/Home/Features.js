                                    ...
                                    <div className=' grid grid-cols-12  gap-4 sm:gap-8 mt-10 ' >
                                          <div className='  col-span-12 sm:col-span-6 lg:col-span-4 xl:col-span-3   ' >
                                                ...
                                                <div className=' mt-4 sm:mt-0 mx-auto bg-black-vdark w-[260px] sm:w-full lg:w-[260px] h-[260px] p-[24px] rounded-[32px] text-center items-center ' >
                                                      ...
                                                      <h2 className=' f-f-m text-lg text-white py-[32px] ' >WallEStake</h2>
                                                </div>
                                          ...
                                          <div className='  col-span-12 sm:col-span-6 lg:col-span-4 xl:col-span-3   ' >
                                                ...
                                                <div className=' mt-4 sm:mt-0 mx-auto bg-black-vdark w-[260px] sm:w-full lg:w-[260px] h-[260px] p-[24px] rounded-[32px] text-center items-center ' >
                                                      ...
                                                      <h2 className=' f-f-m text-lg text-white py-[32px] ' >WallENFT</h2>
                                                </div>
                                          ...
                                          <div className='  col-span-12 sm:col-span-6 lg:col-span-4 xl:col-span-3   ' >
                                                ...
                                                <div className=' mt-4 sm:mt-0 mx-auto bg-black-vdark w-[260px] sm:w-full lg:w-[260px] h-[260px] p-[24px] rounded-[32px] text-center items-center ' >
                                                      ...
                                                      <h2 className=' f-f-m text-lg text-white py-[32px] ' >WallEVerse</h2>
                                                </div>
                                          ...
                                          <div className='  col-span-12 sm:col-span-6 lg:col-span-4 xl:col-span-3   ' >
                                                ...
                                                <div className=' mt-4 sm:mt-0 mx-auto bg-black-vdark w-[260px] sm:w-full lg:w-[260px] h-[260px] p-[24px] rounded-[32px] text-center items-center ' >
                                                      ...
                                                      <h2 className=' f-f-m text-lg text-white py-[32px] ' >WallEDEX</h2>
                                                </div>
                                          ...
                                          <div className='  col-span-12 sm:col-span-6 lg:col-span-4 xl:col-span-3   ' >
                                                ...
                                                <div className=' mt-4 sm:mt-0 mx-auto bg-black-vdark w-[260px] sm:w-full lg:w-[260px] h-[260px] p-[24px] rounded-[32px] text-center items-center ' >
                                                      ...
                                                      <h2 className=' f-f-m text-lg text-white py-[32px] ' >WallEMerchandise</h2>
                                                </div>
                                          ...
                                          <div className='  col-span-12 sm:col-span-6 lg:col-span-4 xl:col-span-3   ' >
                                                ...
                                                <div className=' mt-4 sm:mt-0 mx-auto bg-black-vdark w-[260px] sm:w-full lg:w-[260px] h-[260px] p-[24px] rounded-[32px] text-center items-center ' >
                                                      ...
                                                      <h2 className=' f-f-m text-lg text-white py-[32px] ' >WallEGameFI</h2>
                                                </div>
                                          ...
                                          <div className='  col-span-12 sm:col-span-6 lg:col-span-4 xl:col-span-3   ' >
                                                ...
                                                <div className=' mt-4 sm:mt-0 mx-auto bg-black-vdark w-[260px] sm:w-full lg:w-[260px] h-[260px] p-[24px] rounded-[32px] text-center items-center ' >
                                                      ...
                                                      <h2 className=' f-f-m text-lg text-white py-[32px] ' >WallESocialFI</h2>
                                                </div>
                                          ...
                                          <div className='  col-span-12 sm:col-span-6 lg:col-span-4 xl:col-span-3   ' >
                                                ...
                                                <div className=' mt-4 sm:mt-0 mx-auto bg-black-vdark w-[260px] sm:w-full lg:w-[260px] h-[260px] p-[24px] rounded-[32px] text-center items-center ' >
                                                      ...
                                                      <h2 className=' f-f-m text-lg text-white py-[32px] ' >WallEHUb</h2>
                                                </div>
