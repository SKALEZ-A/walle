    ...
    return (
        <div className='w-[91%] xl:max-w-[1080px] mx-auto my-[96px] '>
            <div className='relative p-4 sm:p-16 text-center  w-full h-[545px] sm:h-[446px] xl:w-[870px] lg:h-[516px] rounded-[50px] bg-black-darkest mx-auto  pup-crd  ' >
                <h2 className=' f-f-sm text-3xl lg:text-5xl pupysaletext mt-[7px] ' >Wall-E NFT's coming soon</h2>
                <h3 className=' text-grey-light f-f-m text-tiny lg:text-base mt-6 '  >An agreement is to be reached between Humans and WallE. And for the first time, something timeless is done solely </h3>
                <h4 className=' f-f-sm text-base pupysaletext my-1  ' >“For the Love of Wall-E”.</h4>
