...
<div className=' col-span-12 xl:col-span-4 hidden xl:block    ' >
        ...
        <h4 className=' f-f-r   leading-[41px] sm:leading-[50px]  text-base lg:text-xl  text-white  text-center xl:text-start  ' >With Renouncement and Liquidity burnt, <span className='  f-f-sm text-primary-light  ' >Wall-E </span> is fully community owned until the community decides  on individuals to represent the project and vote On Various Proposed Features to Develop, with Innovators and Developers Drawn from Community or Human Population for its Individual Development.</h4>
                  </div>
