...
import Logocontract from '../../assets/images/gaspump.jpg'
      ...
      <div className=' w-[91%] xl:max-w-[1512px] mx-auto sm:my-[96px] my-[64px] ' >
        <div className='max-w-[869px] mx-auto  text-center relative' >
          <h2 className=' f-f-r-b font-medium text-xl md:text-4xl text-primary  ' >
            $Wall-E Contract Is Audited
          </h2>
          <p className=' text-grey-dark f-f-m text-tiny  sm:text-base mt-4 sm:mt-0 ' >
            To ensure safety of the community, $Wall-E Contract is Audited and will continually be subjected to regular industry highest safety standards.
          </p>

          <div className=' cntrct-crd  rounded-[24px] p-[48px] my-20 ' >
          <div className='  text-center  ' >
                <img src={Logocontract} className=' w-[37px] rounded-lg h-[43px] mx-auto  ' />
                <h2 className=' f-f-b text-3xl text-white   mt-2 ' >GAS PUMP</h2>
                <h4 className=' f-f-r text-tiny text-white ' >15th July, 2024</h4>
              </div>
